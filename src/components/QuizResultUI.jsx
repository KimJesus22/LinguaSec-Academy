...
const QuizResultUI = ({ score, totalQuestions, levelData, mensaje, onRetry, onExit, languageName }) => {
    ...
    return (
        <div className="w-full max-w-2xl bg-cyber-dark border border-neon-cyan/50 rounded-2xl p-8 shadow-[0_0_50px_rgba(0,243,255,0.15)] text-center animate-fade-in-up relative overflow-hidden font-mono">
            {/* Decorative background glow */}
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-neon-cyan/10 rounded-full blur-3xl -z-10"></div>

            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2 uppercase tracking-widest animate-glitch title-glitch">Informe de Nivelación</h2>
            <div className="h-1 w-24 bg-neon-cyan mx-auto mb-8 rounded-full shadow-[0_0_10px_#00f3ff]"></div>
            ...
            <div className="mb-8 p-6 bg-black/60 rounded-xl border border-gray-800 backdrop-blur-sm transform transition-all hover:border-neon-purple/50">
                <p className="text-gray-300 text-lg mb-2 uppercase tracking-widest">Nivel Identificado:</p>
                <div className={`text-6xl font-bold mb-2 ${levelData.color} drop-shadow-[0_0_15px_rgba(0,0,0,0.8)] animate-pulse-glow`}>
                    {levelData.nivel}
                </div>
            ...
            <p className="text-gray-300 italic mb-8 text-lg px-4 border-l-2 border-neon-purple/50 bg-gradient-to-r from-neon-purple/5 to-transparent py-4 text-left">
            > "{mensaje}"
            </p>
